...
def local_bathy_estimator_factory(location: PointType, images_sequence: ImagesSequence,
    ...
    return local_bathy_estimator_cls(location, images_sequence, global_estimator,
                                     selected_directions)
