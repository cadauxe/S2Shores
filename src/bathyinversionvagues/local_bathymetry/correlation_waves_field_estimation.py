...
# TODO: this is a copy of the SpatialDFTWavesFieldEstimation class which is suited to the
# SpatialDFTBathyEstimator.. Must be adapted to suit the needs of CorrelationBathyEstimator
